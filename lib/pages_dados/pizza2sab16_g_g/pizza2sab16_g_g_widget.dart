...
import 'pizza2sab16_g_g_model.dart';
export 'pizza2sab16_g_g_model.dart';

class Pizza2sab16GGWidget extends StatefulWidget {
  const Pizza2sab16GGWidget({Key? key}) : super(key: key);

  @override
  _Pizza2sab16GGWidgetState createState() => _Pizza2sab16GGWidgetState();
}

class _Pizza2sab16GGWidgetState extends State<Pizza2sab16GGWidget> {
  late Pizza2sab16GGModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pizza2sab16GGModel());
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              formatNumber(
                                                                                listViewProdutosRow.valorProduto! / 2,
